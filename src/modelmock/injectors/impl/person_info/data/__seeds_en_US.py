...
class personal_lookup:
    first_names_male_dict = OrderedDict((
        ('Aaron', 0.006741589),
        ('Adam', 0.007124922),
        ('Adrian', 0.001521889),
        ('Alan', 0.002344657),
    ...
    first_names_female_dict = OrderedDict((
        ('April', 0.004529083),
        ('Abigail', 0.002043839),
        ('Adriana', 0.000488767),
    ...
    first_names_male = list(dict(first_names_male_dict).keys())
    first_names_female = list(dict(first_names_female_dict).keys())
    last_names = list(dict(last_names_dict).keys())
