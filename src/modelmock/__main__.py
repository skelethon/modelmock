...
def main(argv=sys.argv):
  ...
  generate_contracts_parser.add_argument("--extra_descriptors", type=str, default="[]", help="extra_descriptors in JSON format")
  ...
  generate_purchases_parser.add_argument("--extra_descriptors", type=str, default="[]", help="extra_descriptors in JSON format")
